    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-2 flex-wrap">
            ...
            @if($isGoogleConnected)
                <span class="px-3 py-1.5 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-bold flex items-center gap-1.5 shadow-2xs">
                    <span class="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
                    <i data-lucide="cloud" class="w-4 h-4"></i>
                    <span>Live Sync Active</span>
                </span>
            @else
                <button type="button" @click="showDriveSetupHelp = true" class="px-3 py-1.5 rounded-xl bg-amber-50 border border-amber-200 text-amber-800 text-xs font-bold flex items-center gap-1.5 hover:bg-amber-100 transition cursor-pointer">
                    <span class="w-2 h-2 rounded-full bg-amber-500"></span>
                    <i data-lucide="cloud-off" class="w-4 h-4"></i>
                    <span>Drive Ready to Connect</span>
                </button>
            @endif
        </div>
    </div>
